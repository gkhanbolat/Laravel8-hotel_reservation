                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach($datalist as $rs)
                                    <tr>
                                        ...
                                        <td><p class="text-xs font-weight-bold mb-0">{{$rs->category->title}}</p></td>
                                        ...
                                        <td class="align-middle text-center text-sm"><p class="text-xs font-weight-bold mb-0"><a href="{{route('admin_rooms',['hotel_id'=>$rs->id])}}" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')"><img src="{{asset('assets/admin/image')}}/gallery.png" height="25"> </a></p></td>
